    ...
    public void list(int filter) {
        ...
        APIListener<List<TaskModel>> listener =  new APIListener<List<TaskModel>>() {
            ...
            public void onFaliure(String massage) {
                mList.setValue(new ArrayList<TaskModel>()); //SE DER FALHA PASSO UMA LISTA VAZIA
                mFeedback.setValue(new Feedback(massage)); //feedback no caso de falha para relatar o problema
            }
        };
