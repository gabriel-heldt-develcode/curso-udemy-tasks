...
public class RetrofitClient {
    ...
    public static Retrofit getRetrofitInstance() {
        ...
        httpClient.addInterceptor(new Interceptor() {    //addInterceptor vai interceptar todas as requisições do retrofit, e quando interceptar vamos inserir o cabeçario (ou Headers)
            @Override
