...
public class TaskViewHolder extends RecyclerView.ViewHolder {
    ...
    private ImageView mImagemComplete = itemView.findViewById(R.id.image_complete);
    ...
    public void bindData(final TaskModel task) {
        ...
        //pegamos uma string e convertemos para o padrao de data local
        try {
        ...
        if (task.getComplete()) {
            this.mImagemComplete.setImageResource(R.drawable.ic_done);
            this.mTextDescription.setTextColor(Color.GRAY);
        } else {
            this.mImagemComplete.setImageResource(R.drawable.ic_todo);
        ...
        this.mTextDescription.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                new AlertDialog.Builder(itemView.getContext())  //confirmação de remoção ou não
        ...
        this.mImagemComplete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (task.getComplete()) {
