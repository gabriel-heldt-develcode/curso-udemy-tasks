...
//        boolean adc =  FingerprintHelper.isAvailable(this);


//        if (getSupportActionBar() != null) {
//            getSupportActionBar().hide();   //esconde a topbar da tela de login
//        }
        ...
        this.mLoginViewModel.isFingerprintAvailable();  //verificar se o aparelho suporta biometria e se o usuário ja cadastrou o login + biometria, para reconhecer sem precisar colocar todos os dados
    }
    ...
    private void openAuthentication() {
        ...
        BiometricPrompt.PromptInfo info = new BiometricPrompt.PromptInfo.Builder()
                ...
                .setNegativeButtonText("Cancelar") // parâmetro obrigatório
                .build();
