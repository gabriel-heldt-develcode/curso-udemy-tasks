...
public class TaskActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener{
    ...
    private void loadDataFromActivity() {
        ...
        if (bundle != null) {
            ...
            this.mViewHolder.buttonSave.setText(this.getString(R.string.update_task));
    ...
    private int getIndex(int id) {
        ...
        for (int i = 0; i < this.mListPriorityId.size(); i++) {
            if (this.mListPriorityId.get(i) == id) {
                index = i;
                break;
            }
        }
    ...
    private void loadSpinner(final List<PriorityModel> list) {
